...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_paycalc2" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#bdcbe3df#;
   pragma Export (C, u00001, "paycalc2B");
   ...
   u00159 : constant Version_32 := 16#422f7d1c#;
   pragma Export (C, u00159, "makereportB");
